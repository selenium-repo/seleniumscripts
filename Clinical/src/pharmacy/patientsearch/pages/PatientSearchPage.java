package pharmacy.patientsearch.pages;
...
public class PatientSearchPage {
	...
	public void checkPatientRow() {
		if (CommonLib.isElementPresent(By.xpath("//div[@id='patientSearchPane']//div[contains(@class,'dojoxGridRow')]/table/tbody/tr/td"), 5)) {
			CommonLib.getElement(By.xpath("//div[@id='patientSearchPane']//div[contains(@class,'dojoxGridRow')]/table/tbody/tr/td")).click();
		}
	}

	public String getPatientName() {
		String pat_name = "";
		if (CommonLib.isElementPresent(By.xpath("//div[@id='patientSearchPane']//div[contains(@class,'dojoxGridRow')]/table/tbody/tr/td[3]"), 4)) {
			pat_name = CommonLib.getElement(By.xpath("//div[@id='patientSearchPane']//div[contains(@class,'dojoxGridRow')]/table/tbody/tr/td[3]")).getText();
	...
	public String getPatientMedRecNo() {
		...
		if (CommonLib.isElementPresent(By.xpath("//div[@id='patientSearchPane']//div[contains(@class,'dojoxGridRow')]/table/tbody/tr/td[5]"), 4)) {
			pat_med_rec_no = CommonLib.getElement(By.xpath("//div[@id='patientSearchPane']//div[contains(@class,'dojoxGridRow')]/table/tbody/tr/td[5]")).getText();
	...
	public String getDateOfBirth() {
		String pat_dob = "";
		if (CommonLib.isElementPresent(By.xpath("//div[@id='patientSearchPane']//div[contains(@class,'dojoxGridRow')]/table/tbody/tr/td[7]"), 4)) {
			pat_dob = CommonLib.getElement(By.xpath("//div[@id='patientSearchPane']//div[contains(@class,'dojoxGridRow')]/table/tbody/tr/td[7]")).getText();
	...
	public int checkDataGridOfStation() {
		int count = 0;
		if (CommonLib.isElementPresent(By.xpath("//div[@id='nameOfGrid']/div[2]/div/div/div/div/div[contains(@class,'dojoxGridRow')]"), 5)) {
			count = CommonLib.getElements(By.xpath("//div[@id='nameOfGrid']/div[2]/div/div/div/div/div[contains(@class,'dojoxGridRow')]")).size();
	...
	public boolean checkForErros() {
		boolean check = true;
		String error_txt = CommonLib.getElement(By.xpath("//div[@id='nameOfGrid']/div[2]/div/div/div/div/div[contains(@class,'dojoxGridRow')]/table/tbody/tr/td")).getText();
